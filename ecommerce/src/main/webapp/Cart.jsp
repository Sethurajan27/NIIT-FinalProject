...
<body>
	...
	<h1 align="left"
		...
		Hello,
		<%=request.getAttribute("name")%><center>Cart</center>
	</h1>
	<center>
		<h1 align="center"
					...
					<div class="col-sm-4">
						<div class="panel panel-primary">
							...
							<div class="panel-body">
								<center><img src="images/${p.productName}.jpg"
									style="width: 170px; height: 150px;" /></center>
							...
							<div class="panel-footer">
								...
								<input type="hidden" name="cartProdprs"
									...
									type="submit" value="Remove form Cart"
